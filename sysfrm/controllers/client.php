  ...
  <input type="submit" value="Pay '.$config['currency_code'].' '.$vamount .'">
                ...
                case 'quickpay':
                    ...
                    if($p){
                        ...
                        $data_fields['continueurl'] = APP_URL . "/?ng=client/ipay_submitted/$invoiceid/token_$vtoken/";
                        $data_fields['cancelurl'] = APP_URL . "/?ng=client/ipay_cancel/$invoiceid/token_$vtoken/";
                        $data_fields['callbackurl'] = APP_URL . "/?ng=client/ipay_ipn/$invoiceid/token_$ptoken/";
